...
import com.nicare.ves.vision.facedetection.VisionProcessorBase;
...
public class FaceDetectorProcessor extends VisionProcessorBase<List<Face>> {
    ...
    @Override
    protected void onSuccess(@NonNull List<Face> faces, @NonNull GraphicOverlay graphicOverlay, Bitmap bitmap) {
        for (Face face : faces) {
