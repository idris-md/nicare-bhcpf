...
package com.nicare.ves.vision.facedetection;
...
import com.nicare.ves.vision.facedetection.preference.PreferenceUtils;
        ...
        return detectInImage(image)
                .addOnSuccessListener(
                        ...
                        results -> {
                            ...
                            VisionProcessorBase.this.onSuccess(results, graphicOverlay, mBitmap);
//                            graphicOverlay.add(
...
//                                            graphicOverlay, currentLatencyMs, shouldShowFps ? framesPerSecond : null));
    ...
    protected abstract void onSuccess(@NonNull T results, @NonNull GraphicOverlay graphicOverlay, Bitmap bitmap);
