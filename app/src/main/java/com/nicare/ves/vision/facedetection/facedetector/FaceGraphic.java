...
package com.nicare.ves.vision.facedetection.facedetector;
...
public class FaceGraphic extends GraphicOverlay.Graphic {
    ...
    private ImageProcessResult mResult;
    ...
    public void draw(Canvas canvas) {
        mResult = new ImageProcessResult();
...
//                labelPaints[colorID]);
        ...
        boxPaint.setColor(Color.parseColor("#F91100"));
...
//                    idPaints[colorID]);
//            yLabelOffset += lineHeight;
            mResult.setSmiling(true);
        } else {
            mResult.setSmiling(false);
        }
...
//                    idPaints[colorID]);
//            if (face.getLeftEyeOpenProbability() >= 0.85)
            mResult.setLeftCheek(true);
        }
...
//                    idPaints[colorID]);
            ...
            if (face.getRightEyeOpenProbability() >= 0.85)
                mResult.setRightEyeOpen(true);
        }
...
//
//        } else {
//            mResult.setRightEyeOpen(false);
//        }

        FaceLandmark rightEar = face.getLandmark(FaceLandmark.RIGHT_EAR);
        if (rightEar != null) {
            mResult.setRightEarOpen(true);
        }

        FaceLandmark leftEar = face.getLandmark(FaceLandmark.LEFT_EAR);
        if (leftEar != null) {
            PointF position = leftEar.getPosition();
            mResult.setLeftEarOpen(true);
        }
...
//        drawFaceLandmark(canvas, FaceLandmark.RIGHT_EAR);
        ...
        if (mImageResultCallBack != null) {
            mImageResultCallBack.imageResultReady(mResult);
            mResult = null;
        }
    ...
    public void setImageResultCallBack(ImageResultCallBack callBack) {
        this.mImageResultCallBack = callBack;
    }
}
